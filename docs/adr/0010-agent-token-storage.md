# 0010 — Agent token storage beyond `localStorage`
...
- ADR [0009](0009-signed-challenge-identity-verification.md)'s
...
- [0001](0001-local-agent-for-web-host.md) — original local agent
  design.
- [0009](0009-signed-challenge-identity-verification.md) — companion
