...
import { ssgSafeBeakHost } from '@beak/web-website/utils/ssg-safe-operations';
	...
	<React.Fragment>
		...
		<SmallContainer>
			...
			<p>
				...
				<Link to={'/pricing'}>{`${ssgSafeBeakHost()}/pricing`}</Link>{'.'}
			</p>
			<p>
			...
			<p>
				...
				<Link to={'/legal/privacy'}>{`${ssgSafeBeakHost()}/legal/privacy`}</Link>
				{'.'}
			</p>
