		...
		<Wrapper flipped={flipped}>
			...
			<Container>
				<Grid flipped={flipped}>
					...
					<VisualContainer>
						<picture>
							<source srcSet={`/images/${asset}.webp`} type={'image/webp'} />
							<source srcSet={`/images/${asset}.jpg`} type={'image/jpeg'} />
							<HighlightAsset loading={'lazy'} src={`/images/${asset}.jpg`} alt={description} />
						</picture>
					</VisualContainer>
				</Grid>
			</Container>
