...
const EntryFolder: React.FunctionComponent<React.PropsWithChildren<EntryFolderProps>> = props => {
...
export const EntryFolderIrrelevant: React.FunctionComponent<React.PropsWithChildren<unknown>> = () => (<Wrapper />);
