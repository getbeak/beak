import type { CookieJarTabItem } from '@beak/common/types/beak-project';
...
interface CookieJarTabProps {
	tab: CookieJarTabItem;
}

const CookieJarTab: React.FC<React.PropsWithChildren<CookieJarTabProps>> = ({ tab }) => {
