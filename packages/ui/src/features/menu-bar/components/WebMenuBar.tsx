...
const MENUS: TopMenu[] = [
	...
	},
	{
		label: 'Edit',
		items: [
			{ kind: 'command', label: 'Execute current request', code: 'execute_request', shortcut: 'global.execute-request', requiresProject: true },
		],
	},
	{
		label: 'View',
		items: [
			...
			{ kind: 'command', label: 'Show variables sidebar', code: 'sidebar_show_variables', shortcut: 'sidebar.switch-variables' },
			{ kind: 'command', label: 'Show extensions sidebar', code: 'sidebar_show_extensions', shortcut: 'sidebar.switch-extensions' },
		],
	},
	{
		label: 'Help',
							...
							<Menu.Positioner>
								...
								>
									{menu.items.map((item, idx) => {
										...
										const disabled =
											(Boolean(item.requiresProject) && !hasProject) ||
											(Boolean(item.requiresBrowserStorage) && !browserStorage);
