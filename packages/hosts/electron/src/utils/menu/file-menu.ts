import { openProjectDialog } from '@beak/host-electron/lib/project';
import { createPreferencesWindow, createWelcomeWindow } from '@beak/host-electron/window-management';
