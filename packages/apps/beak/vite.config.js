...
// @ts-ignore
const packageJson = require('../../hosts/electron/package.json');
...
module.exports = {
	...
	resolve: {
		alias: {
			'@beak/app-beak': path.join(__dirname, './src'),
			'@beak/shared-common': path.join(__dirname, `../../shared/common/${sourcePath}`),
			'@beak/shared-design-system': path.join(__dirname, `../../shared/design-system/${sourcePath}`),
		},
	},
	plugins: [
