import { attemptReconciliation, closeTab, loadTabState } from '@beak/app-beak/features/tabs/store/actions';
import { readFolderNode } from '@beak/app-beak/lib/beak-project/folder';
import { readProjectFile } from '@beak/app-beak/lib/beak-project/project';
import { readRequestNode } from '@beak/app-beak/lib/beak-project/request';
import createFsEmitter, { scanDirectoryRecursively, ScanResult } from '@beak/app-beak/lib/fs-emitter';
import { ipcDialogService, ipcEncryptionService, ipcWindowService } from '@beak/app-beak/lib/ipc';
import actions, { alertInsert } from '@beak/app-beak/store/project/actions';
import { FolderNode, ProjectFile, RequestNode, Tree } from '@beak/shared-common/types/beak-project';
