...
import { readVariableGroup } from '@beak/app-beak/lib/beak-variable-group';
...
import { EditorPreferences } from '@beak/shared-common/types/beak-hub';
import { VariableGroups } from '@beak/shared-common/types/beak-project';
